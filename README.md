...
The viewer shows a Scripthea image depot (a folder with bunch of images and decription.txt file for the prompts). Organize and review generated images alongside their corresponding prompts. The viewer supports both grid and table views, aiding in visual analysis and comparison.
