...
namespace UtilsNS
{
    ...
    public static class Utils
    {
        ...
        public static Bitmap SaveImage(string imageUrl) //, string filename, ImageFormat format)
        {
        ...
        public static List<string> readList(string filename, bool skipRem = true)
        {
            ...
            if (!File.Exists(filename)) return ls;
        ...
        {
            int returnValue = MessageBoxTimeout(IntPtr.Zero, text, title, Convert.ToUInt32(0), 1, 5000); //milliseconds
